...
@Entity(name="solialumno")
public class Solialumno implements Serializable {
    ...
    /**
     * Compares the key for this instance with another Solialumno.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Solialumno and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof Solialumno)) {
            return false;
        }
        Solialumno that = (Solialumno) other;
    ...
    /**
     * Compares this instance with another Solialumno.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof Solialumno)) return false;
        return this.equalKeys(other) && ((Solialumno)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[Solialumno |");
